...
// Stack Operations
void push1(int x);	// Function to insert an element onto the stack1
void push2(int x);			// Function to insert an element onto the stack2
void pop1();			// Function to delete an element from the stack1
void pop2();			// Function to delete an element from the stack2
